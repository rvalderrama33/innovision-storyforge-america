...
import { FileText, Store, Users, Mail, TrendingUp, Package, ShoppingCart, CreditCard, BarChart3, Settings, ArrowRight } from 'lucide-react';
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-2 hover:border-blue-200">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                <h5 className="font-medium text-gray-900 mb-2">Perfect for:</h5>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary">Editorial Teams</Badge>
                  <Badge variant="secondary">Content Managers</Badge>
          ...
          <Card className="group hover:shadow-lg transition-all duration-300 border-2 hover:border-green-200">
            ...
            <CardContent className="space-y-6">
              ...
              <div className="bg-green-50 rounded-lg p-4">
                <h5 className="font-medium text-gray-900 mb-2">Perfect for:</h5>
                <div className="flex flex-wrap gap-2">
                  <Badge variant="secondary">E-commerce Managers</Badge>
