-- Temporarily drop the reviewer_id foreign key constraint to add fake reviews
ALTER TABLE marketplace_reviews DROP CONSTRAINT IF EXISTS marketplace_reviews_reviewer_id_fkey;

-- Add a reviewer_name column to store fake reviewer names
ALTER TABLE marketplace_reviews ADD COLUMN IF NOT EXISTS reviewer_name TEXT;
...
BEGIN
    ...
    LOOP
        ...
        FOR i IN 1..review_count LOOP
            ...
            fake_reviewer_id := gen_random_uuid();
